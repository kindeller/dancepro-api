...
| 8 | Medium | Standard HTTP security headers are not applied | Resolved - pending commit approval | Global middleware now applies MIME-sniffing, same-origin framing, referrer and browser-feature restrictions, plus one-year HSTS for production HTTPS; CSP is documented as deferred to avoid breaking current inline assets; 241 tests / 1,893 assertions and Pint pass. |
