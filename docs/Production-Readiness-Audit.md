...
| 20 | Maintainability | Visual styles are duplicated across Blade layouts | Resolved - pending commit approval | The universal box-sizing and hidden-element rules are shared by the admin, My Hub and public media layouts; their intentionally distinct visual systems remain isolated to avoid cross-section regressions; 230 tests / 1,829 assertions. |
