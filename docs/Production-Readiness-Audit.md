...
| 9 | Medium | The concert-player production bundle exceeds the build warning threshold | Resolved - pending commit approval | The 4.3 kB concert entry now lazy-loads the 359 kB HLS.js light build only when native HLS is unavailable; the production build completes without chunk-size warnings and retains MP4 fallback. |
